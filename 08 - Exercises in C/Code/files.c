 ...
 * esattamente una occorrenza. La funzione ritorni un valore negativo se le scritture su file comportano errori, altrimenti
 * ritorni il numero di linee eliminate.
 * 
